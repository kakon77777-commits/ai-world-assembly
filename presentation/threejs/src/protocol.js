const EVENT_EFFECTS=Object.freeze({'movement.actor_moved':'move-entity','alien_lineage.creature_fed':'pulse-feed','alien_lineage.creature_mutated':'rebuild-creature','alien_lineage.creature_grew':'rebuild-creature','alien_lineage.egg_laid':'egg-effect','alien_lineage.egg_hatched':'hatch-effect','alien_lineage.rift_entered':'rift-transition'});
